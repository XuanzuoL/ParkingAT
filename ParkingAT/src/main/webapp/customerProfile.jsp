...
<div class="row">
    <div class="center">
	<aside class="menu">
            <li ><a href= "./customerProfileElement/personinfo.html" target="main">Personal Information</a></li>
	        <li ><a href="./customerProfileElement/reservation.html" target="main">Reservation</a></li>
            <li ><a href= "./customerProfileElement/message.html" target="main">Message</a></li>
            <li ><a href= "./customerProfileElement/history.html" target="main">History</a></li>
    ...
    <div class="col-main">
        <div class="main-wrap">
            <iframe id="external-frame" scrolling="no" onload="setIframeHeight(this)" name="main" width=800px scrolling="auto" height=1000px src="customerProfile copy.html" frameborder="0"></iframe>
        </div>
    </div>
</div>
